...
\boxed{\textbf{Tous les résultats seront encadrés.}} $+1$ point sur la note finale si les résultats sont encadrés, $-1$ point si non. $-1$ point par jour non rendu. 1 point sera affectés à la propreté de la copie.
...
\begin{solution}
\begin{parts}
\part $(2x-1)^2 + (x-1)(2x-1) = 0 \iff (2x-1)\left[(2x-1)+(x-1)\right]= 0 \iff (2x-1)(3x-2) = 0 \iff 2x-1 = 0 \text{ ou } 3x-2= 0 \iff x=\dfrac{1}{2} \text{ ou } x=\dfrac{2}{3}$. Donc, l'ensemble des solutions est $\boxed{S=\llbrace \dfrac{1}{2}; \dfrac{2}{3}\rrbrace}$.
